...
highlight pgnTagName                 cterm=none       ctermfg=lightmagenta
highlight pgnTagValue                cterm=none       ctermfg=lightblue
highlight pgnMoveNumber              cterm=none       ctermfg=lightblue
highlight pgnPiece                   cterm=underline  ctermfg=none
highlight pgnDeparture               cterm=none       ctermfg=lightblue
highlight pgnArrival                 cterm=none       ctermfg=none
highlight pgnAbbreviation            cterm=none       ctermfg=lightcyan
highlight pgnPromotion               cterm=italic     ctermfg=none
highlight pgnDrawOffer               cterm=none       ctermfg=lightmagenta
highlight pgnCastling                cterm=none       ctermfg=lightblue
highlight pgnMoveEvaluation          cterm=none       ctermfg=lightred
highlight pgnNovelty                 cterm=none       ctermfg=lightred
highlight pgnPositionEvaluation      cterm=none       ctermfg=lightmagenta
highlight pgnDiagram                 cterm=reverse    ctermfg=lightred
highlight pgnNumericAnnotationGlyph  cterm=none       ctermfg=lightred
highlight pgnVariation               cterm=italic     ctermfg=lightgrey
highlight pgnResult                  cterm=none       ctermfg=lightmagenta
highlight pgnCommentBlock            cterm=none       ctermfg=lightgreen
highlight pgnCommentSingleLine       cterm=none       ctermfg=lightgreen

highlight pgnTagName                 gui=none       guifg=lightmagenta
highlight pgnTagValue                gui=none       guifg=lightblue
highlight pgnMoveNumber              gui=none       guifg=lightblue
highlight pgnPiece                   gui=underline  guifg=foreground
highlight pgnDeparture               gui=none       guifg=lightblue
highlight pgnArrival                 gui=none       guifg=foreground
highlight pgnAbbreviation            gui=none       guifg=lightcyan
highlight pgnPromotion               gui=italic     guifg=foreground
highlight pgnDrawOffer               gui=none       guifg=lightmagenta
highlight pgnCastling                gui=none       guifg=lightblue
highlight pgnMoveEvaluation          gui=none       guifg=lightred
highlight pgnNovelty                 gui=none       guifg=lightred
highlight pgnPositionEvaluation      gui=none       guifg=lightmagenta
highlight pgnDiagram                 gui=reverse    guifg=lightred
highlight pgnNumericAnnotationGlyph  gui=none       guifg=lightred
highlight pgnVariation               gui=italic     guifg=lightgrey
highlight pgnResult                  gui=none       guifg=lightmagenta
highlight pgnCommentBlock            gui=none       guifg=lightgreen
highlight pgnCommentSingleLine       gui=none       guifg=lightgreen
